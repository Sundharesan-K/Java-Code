...
import com.dailyCodeBuffer.springWeb.repository.PersonRepository;
...
public class PersonServiceImpl implements PersonService{
    ...
    public Person getByPersonId(String personId) {
        return personRepository.findById(personId).orElseThrow(()->new RuntimeException(personId+" this id does not exists"));
    }
    ...
    public Page<Person> search(String name, Integer minAge, Integer maxAge, String city, Pageable pageable) {
        ...
        Page<Person> people = PageableExecutionUtils.getPage(
                mongoTemplate.find(query,Person.class),pageable,()->mongoTemplate.count(query.limit(0)
                        .skip(0),Person.class));
        return people;
    }
